...
@Component({
  selector: 'app-taxdeductionemployeemonthlyreport',
  templateUrl: './taxdeductionemployeemonthlyreport.component.html',
  styleUrls: ['./taxdeductionemployeemonthlyreport.component.css']
})
export class TaxdeductionemployeemonthlyreportComponent {
